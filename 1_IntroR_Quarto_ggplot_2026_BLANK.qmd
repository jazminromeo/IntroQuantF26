...
THIS TUTORIAL COMPLETED BY: Jaz Romero
...
```{r}
head(candy_rankings) # see first six rows
```
...
```{r}
fruitystatus <- ggplot(candy_rankings) + aes(x = fruity, y = pricepercent) + geom_boxplot()
